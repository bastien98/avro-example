...
public class Notification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8729858020313494458L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Notification\",\"namespace\":\"thesis.avro.example.types\",\"fields\":[{\"name\":\"InvoiceNumber\",\"type\":[\"null\",\"string\"]},{\"name\":\"CustomerCardNo\",\"type\":[\"null\",\"double\"]},{\"name\":\"TotalAmount\",\"type\":[\"null\",\"double\"]},{\"name\":\"EarnedLoyaltyPoints\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public static thesis.avro.example.types.Notification.Builder newBuilder() {
    return new thesis.avro.example.types.Notification.Builder();
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static thesis.avro.example.types.Notification.Builder newBuilder(thesis.avro.example.types.Notification.Builder other) {
    return new thesis.avro.example.types.Notification.Builder(other);
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static thesis.avro.example.types.Notification.Builder newBuilder(thesis.avro.example.types.Notification other) {
    return new thesis.avro.example.types.Notification.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Notification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(thesis.avro.example.types.Notification.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(thesis.avro.example.types.Notification other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.InvoiceNumber)) {
        this.InvoiceNumber = data().deepCopy(fields()[0].schema(), other.InvoiceNumber);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder setInvoiceNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder clearInvoiceNumber() {
      InvoiceNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder setCustomerCardNo(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder clearCustomerCardNo() {
      CustomerCardNo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder setTotalAmount(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder clearTotalAmount() {
      TotalAmount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder setEarnedLoyaltyPoints(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public thesis.avro.example.types.Notification.Builder clearEarnedLoyaltyPoints() {
