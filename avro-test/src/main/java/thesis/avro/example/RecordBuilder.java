...
package thesis.avro.example;

import thesis.avro.example.types.HadoopRecord;
import thesis.avro.example.types.LineItem;
import thesis.avro.example.types.Notification;
import thesis.avro.example.types.PosInvoice;
